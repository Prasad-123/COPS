...
{
	$No=$_POST['No'];
	$sql="SELECT * FROM examfees WHERE No='".$No."'LIMIT 1";
	$rec=mysql_query($sql);
...
document.getElementById("demo").innerHTML = Date();
 ...
 <form method="POST" action="examfees.php" > 
...
?>
		...
		<a href="paid.php" onclick="return confirm('Are you sure?')">Proceed to Payment</a>
