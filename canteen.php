...
$sql="SELECT * FROM canteen LIMIT 1";
if(isset($_POST['items']))
{
	$items=$_POST['items'];
	$sql="SELECT * FROM canteen WHERE items='".$items."'LIMIT 1";
	$rec=mysql_query($sql);
...
document.getElementById("demo").innerHTML = Date();
    ...
    <header id="header" class="hoc clear"> 
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="#">MISCELLANEOUS</a>
            <ul>
 ...
 <form method="POST" action="canteen.php" > 
...
<th>Rate</th>
<tr>
<label><b>Item name to pay</b></label>
    <input type="text" placeholder="item name" name="items" required>
